...
```
  ...
  Model 1 shows that the intercept -4.81 and coefficient 0.05 of arm are both of these are both significantly different from zero. 
...
cor(data)
```
Wha this shows is that sims corilates with grip ad arm values. 
`
